...
function uploadImage($file,&$errors){
    ...
    if($file['error'] !== UPLOAD_ERR_OK){
        ...
        $errors[] = "Błąd uploadowania pliku.";
        return;
    }
    ...
    if($file['size'] > $FILE_MAX_SIZE){
        ...
        $errors[] = "Plik jest zbyt duży! Maksymalna wielkosc to 5 mb.";
        return;
    }
    ...
    if(!isset($allowedTypes[$mime])){
        ...
        $errors[] = "Plik nie jest obsługiwany! Dozwolone pliki to .jpg, .jpeg, .png";
        return;
    }
    ...
    if(!move_uploaded_file($file['tmp_name'],$final_path)){
        $errors[] = "Nie udało się uploadować pliku.";
        return;
    }
